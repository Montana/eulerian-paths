...
def eulerian(*args):
    ...
    for graph in graphs:
        ...
        edges_object = list(graph_dict.values())
        edges = []
        ...
        sets = [[vertex, edge] for vertex, edge in updated_graph_dict.items()]
        ...
        for vertex in sets:
            ...
            while len(vertex[-1]) != 0:
                ...
                output = dfs(
                    updated_graph_dict, vertex[0], edges_dict, last_edge, last_vertex
                )
